...
filename = 'computational_epistemology/bernoulli_simulations/output/epsilonRange_n9_p6_steps1000.csv'
...
epsilon = 0.1 # How often agent explores arm of perceived lesser value
...
with open(filename, 'w', newline='') as file:
    ...
    writer.writerow(['scenario', 'network_structure', 'which_arm_restricted', 'ps[0]', 'ps[1]', 'num_agents', 'epsilon', 'n_steps', 'n_success', 'n_runs', 'avg_time_to_converge', 'min_time_to_converge', 'median_time_to_converge', 'max_time_to_converge', 'stnd_dev_time_to_converge'])
    ...
    for epsilon in epsilon_values:
        ...
        writer.writerow(['baseline', 'complete', 'N/A', ps[0], ps[1], num_agents, epsilon, steps, n_success, runs, avg_time_to_converge, min_time_to_converge, median_time_to_converge, max_time_to_converge, stnd_dev_time_to_converge])
        ...
        for which_arm_restricted in which_arm_restricted_params:
            ...
            # writer.writerow(['scenario', 'network_structure', 'which_arm_restricted', 'ps[0]', 'ps[1]', 'num_agents', 'steps_until_change', 'n_steps', 'n_success', 'n_runs', 'avg_time_to_converge', 'min_time_to_converge', 'median_time_to_converge', 'max_time_to_converge', 'stnd_dev_time_to_converge'])
            writer.writerow(['restrict_dissemination', 'star', which_arm_restricted, ps[0], ps[1], num_agents, epsilon, steps, n_success, runs, avg_time_to_converge, min_time_to_converge, median_time_to_converge, max_time_to_converge, stnd_dev_time_to_converge])
