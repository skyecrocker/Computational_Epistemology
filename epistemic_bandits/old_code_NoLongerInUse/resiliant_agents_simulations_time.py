...
output_file = 'c:/Users/skyec/Desktop/Projects/Research/computational_epistemology/bernoulli_simulations/output/time_inertia5_n9_p6.csv'
...
inertia_values = np.arange(0, 11, 1)


with open(output_file, 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)

    metadata_header = ['scenario', 'which_arm_restricted', 'num_agents', 'p', 'inertia', 'sim_id', 'agent_id', 'was_correct', 'time_to_lock']
    ...
    #for inertia in inertia_values:
        ...
        for i in range(num_agents):
            if priors == "uniform" or priors == "u":
                agent_list.append(beta_agents.BetaAgentUniformPriors(num_machines, resiliance=inertia))
            elif priors == "jeffrey" or priors == "j":
                agent_list.append(beta_agents.BetaAgentJeffreyPriors(num_machines, resiliance=inertia))
            elif priors == "random" or priors == "r":
                agent_list.append(beta_agents.BetaAgentRandomPriors(num_machines, resiliance=inertia))
            else:
                agent_list.append(beta_agents.BetaAgentUniformPriors(num_machines, resiliance=inertia))
        ...
        for r in range(runs):
            ...
            for i, agent in enumerate(agent_list):
                ...
                rowdata = ['baseline', 'N/A', num_agents, p, inertia, r, i, last_choices[i] == target, ttl]
        ...
        for r in range(runs):
            ...
            for i, agent in enumerate(agent_list):
                ...
                rowdata = ['restrict_dissemination', what_arm, num_agents, p, inertia, r, i, last_choices[i] == target, ttl]
